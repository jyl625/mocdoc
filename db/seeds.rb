...
all_npi.each do |npi|
  ...
  all_rand_hios_ids.each {|hios_id| ProviderInsurance.create({npi: npi, hios_id: hios_id})}
  # all_rand_hios_ids.each do |hios_id| 
  #   prov_ins = ProviderInsurance.new({npi: npi, hios_id: hios_id})
  #   debugger
  # end
end